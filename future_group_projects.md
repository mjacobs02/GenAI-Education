...
- **A. AI as a project designer** – Use AI to help you create clear materials and information for assignments such as key milestones, rubrics and checklists.
- **B. AI as a “fake stakeholder”** – Students can present their plans to AI acting as a client, investor, or policy-maker. The AI asks probing questions, challenges assumptions, and offers alternative viewpoints. This forces teams to justify their decisions and adapt their work based on realistic client feedback.
- **C. AI as a coach** – Have students reflect alongside AI to improve collaboration, communication, or problem-solving within their group.

---

```{image} ./Images/Button_FutureGroupProjects.png
:alt: Button Accessing GPT Future Group Projects
