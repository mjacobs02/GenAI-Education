...
1. What cognitive work is essential for students to do themselves? Ask yourself what genuinely builds the competencies they need.
2. What can AI legitimately help with? If AI can retrieve information or generate initial analysis, that's not necessarily bad. However, the learning outcome must require students to do something with that AI-generated content.
...
```{image} ./Images/Button_learning_objectives.png
:alt: Button Accessing GPT Learning Objectives
